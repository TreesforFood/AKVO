...
akvo_tree_registration_areas.organisation,
s4G_api_data_general.partner_site_id,
s4G_api_data_general.contract_number,
s4G_api_data_general.country,
s4G_api_data_general.trees_planted AS number_trees_registered,
s4G_api_data_general.nr_photos_taken,
s4G_api_data_general.issues AS geometric_sum_errors_detected,
s4G_api_data_general.invalid_polygon AS geometric_error_polygon,
s4G_api_data_general.invalid_point AS geometric_error_point,
s4G_api_data_general.unconnected AS geometric_error_sliver_polygon,
s4G_api_data_general.area_too_large AS geometric_error_area_too_large,
s4G_api_data_general.area_too_small AS geometric_error_area_too_small,
s4G_api_data_general.overlap AS AS geometric_error_area_boundary_overlap_other_site,
s4G_api_data_general.circumference_too_large AS geometric_error_boundary_too_large,
s4G_api_data_general.site_not_in_country AS geometric_error_site_not_in_country,
s4G_api_data_general.area_water_ha AS geometric_error_water_body_located_in_site,
s4G_api_data_general.area_urban_ha AS geometric_error_urban_body_located_in_site,
s4G_api_data_general.artificially_created_polygon AS buffer_area_around_point_location,
s4G_api_data_general.health_index,
s4G_api_data_general.health_index_normalized,
s4G_api_data_general.health_trend,
s4G_api_data_general.health_trend_normalized,
akvo_tree_registration_areas.centroid_coord
