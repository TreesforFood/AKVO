...
nursery_registration_type TEXT, nursery_registration_name TEXT,nursery_registration_establishment TEXT, nursery_registration_full_production_capacity INTEGER, nursery_monitoring_tree_capacity INTEGER, photo_nursery_bed_1 TEXT,
...
CREATE TABLE odk_nursery_monitoring_main (submissionid_odk TEXT, user_name TEXT, organisation TEXT, field_date DATE, submission_date DATE, name_nursery_monitoring TEXT, method_data_collection TEXT, form_version TEXT, ecosia_nursery_id TEXT, test_data_yes_no TEXT, reporting_type TEXT,
...
json_main_nursery_registration_and_monitoring = client.submissions.get_table(form_id='nursery_reporting')['value']
...
for json_in in json_main_nursery_registration_and_monitoring:
    ...
    if json_extract(json_in, 'reporting_type')[0] == 'existing_nursery':
        ...
        device_id = json_extract(json_in, 'device_id')[0]
        submission_date = json_extract(json_in, 'today')[0]
        method_data_collection = 'nursery monitoring'
        form_version = json_extract(json_in, 'formVersion')[0]
        test_data_yes_no = json_extract(json_in, 'test_data_yes_no')[0]
        user_name = json_extract(json_in, 'username')[0]
        organisation = json_extract(json_in, 'organisation')[0]
        contract_number_to_monitor_save = json_extract(json_in, 'contract_number_to_monitor')[0]
        name_nursery_monitoring = json_extract(json_in, 'name_nursery_monitoring')[0]
        reporting_type = json_extract(json_in, 'reporting_type')[0]
        submissionid_odk = json_extract(json_in, 'instanceID')[0]
        ecosia_nursery_id = json_extract(json_in, 'instanceid')[0]
        instanceID = json_extract(json_in, 'instanceID')[0]
        ...
        cur.execute('''INSERT INTO odk_nursery_monitoring_main (submissionid_odk, user_name, organisation, field_date, submission_date, ecosia_nursery_id, name_nursery_monitoring, method_data_collection, form_version, test_data_yes_no, reporting_type,
        ...
        submission_date, nursery_id_to_monitor, name_nursery_monitoring, method_data_collection, form_version, test_data_yes_no, reporting_type, contract_number_to_monitor_save, nursery_monitoring_manager, nursery_monitoring_gender_manager, nursery_monitoring_nr_people, nursery_monitoring_challenges,
...
for json_in in json_main_nursery_registration_and_monitoring:
    ...
    if json_extract(json_in, 'reporting_type')[0] == 'new_nursery' and json_extract(json_in, 'select_tree_production')[0] == 'tree_production':
        ...
        submission_date = json_extract(json_in, 'submissionDate')[0]
        ecosia_nursery_id = json_extract(json_in, 'instanceid')[0]
        name_nursery_registration = json_extract(json_in, 'nursery_registration_name')[0]
        method_data_collection = 'nursery registration'
        form_version = json_extract(json_in, 'formVersion')[0]
        test_data_yes_no = json_extract(json_in, 'test_data_yes_no')[0]
        reporting_type = json_extract(json_in, 'reporting_type')[0]
        contract_number_save = json_extract(json_in, 'contract_number_save')[0]
        nursery_registration_manager = json_extract(json_in, 'nursery_monitoring_manager')[0]
        nursery_registration_gender_manager = json_extract(json_in, 'nursery_monitoring_gender_manager')[0]
        nursery_registration_nr_people = json_extract(json_in, 'nursery_monitoring_nr_people')[0]
        nursery_registration_challenges = json_extract(json_in, 'nursery_monitoring_challenges')[0]
        nursery_registration_tree_capacity = json_extract(json_in, 'nursery_monitoring_tree_capacity')[0]
        nursery_registration_tree_species = json_extract(json_in, 'nursery_monitoring_tree_species')[0]
        nursery_registration_tree_species_other = json_extract(json_in, 'nursery_monitoring_tree_species_other')[0]
        month_first_distribution = json_extract(json_in, 'month_first_distribution')[0]
        nursery_registration_planting_months = json_extract(json_in, 'nursery_monitoring_planting_months')[0]
