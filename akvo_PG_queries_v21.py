...
drop_a26 = '''DROP TABLE IF EXISTS s4g_ecosia_site_health;'''
drop_a27 = '''DROP TABLE IF EXISTS s4g_ecosia_fires;'''
drop_a28 = '''DROP TABLE IF EXISTS s4g_ecosia_deforestation;'''
drop_a29 = '''DROP TABLE IF EXISTS s4g_ecosia_landuse_cover;'''
...
S4G_API_data_quality_health.nr_photos_taken,
S4G_API_data_quality_health.issues AS geometric_sum_errors_detected,
S4G_API_data_quality_health.invalid_polygon AS geometric_error_polygon,
S4G_API_data_quality_health.invalid_point AS geometric_error_point,
S4G_API_data_quality_health.unconnected AS geometric_error_sliver_polygon,
S4G_API_data_quality_health.area_too_large AS geometric_error_area_too_large,
S4G_API_data_quality_health.area_too_small AS geometric_error_area_too_small,
S4G_API_data_quality_health.overlap AS geometric_error_area_boundary_overlap_other_site,
S4G_API_data_quality_health.circumference_too_large AS geometric_error_boundary_too_large,
S4G_API_data_quality_health.site_not_in_country AS geometric_error_site_not_in_country,
S4G_API_data_quality_health.area_water_ha AS geometric_error_water_body_located_in_site,
S4G_API_data_quality_health.area_urban_ha AS geometric_error_urban_body_located_in_site,
S4G_API_data_quality_health.artificially_created_polygon AS buffer_area_around_point_location,
...
ORDER BY S4G_API_data_quality_health.issues DESC'''
...
cur.execute(drop_a27)
cur.execute(drop_a28)
cur.execute(drop_a29)
