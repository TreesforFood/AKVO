...
cur.execute('''CREATE TABLE ODK_Tree_monitoring_main (submissionid_odk TEXT, ecosia_site_id TEXT, submission_date DATE, form_version TEXT, field_date DATE, username TEXT,
...
for json_in_main in json_monitoring_main:
    ...
    if json_extract(json_in_main, 'reporting_type')[0] == 'existing_site':
        ...
        contract_number_added_trees = json_extract(json_in_main, 'contract_number_added_trees_save')[0]
        ...
        submissionid_odk, ecosia_site_id, submission_date, form_version, field_date, username, country, organisation, id_planting_site, test, reporting_type,
        ...
        (submissionid_odk, ecosia_site_id, submission_date, form_version, field_date, username, country_registration_save, organisation, id_planting_site, test, reporting_type,
