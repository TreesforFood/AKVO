...
cur.execute('''CREATE TABLE ODK_Tree_monitoring_main (submissionid_odk TEXT, ecosia_site_id TEXT, submitter TEXT, submission_date DATE, form_version TEXT, field_date DATE, updated_at TIMESTAMPTZ, username TEXT,
...
remap_line_planting_site geography(LINESTRING, 4326), remap_point_planting_site geography(POINT, 4326), nr_added_trees INTEGER, planting_date_added DATE, contract_number_added_trees NUMERIC(20,2), tree_species_added TEXT,
...
def process_page(json_monitoring_main):
    ...
    for json_in_main in json_monitoring_main:
        ...
        if json_extract(json_in_main, 'reporting_type')[0] == 'existing_site':
            ...
            submitter = json_extract(json_in_main, 'username')[0]
            ...
            planting_date_added = json_extract(json_in_main, 'planting_date_added')[0]
            ...
            submissionid_odk, ecosia_site_id, submitter, submission_date, form_version, field_date, updated_at, username, country, organisation, id_planting_site, test, reporting_type,
            monitoring_type, monitoring_method, contract_number_monitoring, landscape_element_type, remaped_polygon_planting_site,
            remap_line_planting_site, remap_point_planting_site, nr_added_trees, planting_date_added, contract_number_added_trees, tree_species_added,
            ...
            (submissionid_odk, ecosia_site_id, submitter, submission_date, form_version, field_date, updated_at, username, country_registration_save, organisation, id_planting_site, test, reporting_type,
            monitoring_type, monitoring_method, contract_number_monitoring, landscape_element_type,
            remaped_polygon_planting_site,remaped_line_planting_site, remaped_point_planting_site, nr_added_trees, planting_date_added,
...
def process_page(json_additional_photos):
    ...
    for json_in_photos in json_additional_photos:
        ...
        try:
            ...
            photo_1 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{photo_1_1}";

        except:
            photo_1 = ''

        try:
            photo_2_1 = json_extract(json_in_photos, 'additional_photo_2')[0]
            photo_2 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{photo_2_1}";
        except:
            photo_2 = ''

        try:
            photo_3_1 = json_extract(json_in_photos, 'additional_photo_3')[0]
            photo_3 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{photo_3_1}";
        except:
            photo_3 = ''

        try:
            photo_4_1 = json_extract(json_in_photos, 'additional_photo_4')[0]
            photo_4 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{photo_4_1}";
        except:
            photo_4 = ''


        if json_in_photos['group_photo_taking']['additional_photo_gps'] != None:
            return_list = convert_point_wkt(json_in_photos['group_photo_taking']['additional_photo_gps']['coordinates'])
            add_photo_gps_location = return_list[0]

        add_photo_remark = json_extract(json_in_photos, 'additional_photo_remark')[0]
...
# call the submissions
print('processing the additional photos...')
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_additional_photos = client.get_all_submissions(form_id, process_page_callback = process_page)


table_name = "Submissions.group_existing_site.group_tree_survival.group_pcq_tree_number.pcq_method_repeat"


def process_page(json_pcq_method):
    count = 0  # You can make this global or return it if you want to track total count outside
    photo_token = odk_photo_token
    ...
    for json_in_pcq in json_pcq_method:
        ...
        tree_photo_q1_1 = json_extract(json_in_pcq, 'tree_photo_q1')[0]
        tree_photo_q1 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{tree_photo_q1_1}";
        ...
        tree_photo_q2_1 = json_extract(json_in_pcq, 'tree_photo_q2')[0]
        tree_photo_q2 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{tree_photo_q2_1}";
        ...
        tree_photo_q3_1 = json_extract(json_in_pcq, 'tree_photo_q3')[0]
        tree_photo_q3 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{tree_photo_q3_1}";
        ...
        tree_photo_q4_1 = json_extract(json_in_pcq, 'tree_photo_q4')[0]
        tree_photo_q4 = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{tree_photo_q4_1}";
...
# call the submissions
print('processing the pcq data...')
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_pcq_method = client.get_all_submissions(form_id, process_page_callback = process_page)



table_name = "Submissions.group_existing_site.group_tree_survival.group_count_tree_number.repeat_tree_count_per_species"

def process_page(json_count_trees):
    count = 0  # You can make this global or return it if you want to track total count outside
...
# call the submissions
print('processing the counted tree data...')
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_count_trees = client.get_all_submissions(form_id, process_page_callback = process_page)
...
def process_page(json_count_tree_photos):
    count = 0  # You can make this global or return it if you want to track total count outside
    photo_token = odk_photo_token
    ...
    for json_in_count_photos in json_count_tree_photos:
        ...
        tree_photo = f"https://ecosia.getodk.cloud/v1/key/{photo_token}/projects/1/forms/planting_site_reporting/submissions/{instanceID}/attachments/{tree_photo_1}";
...
# call the submissions
print('processing the tree photos...')
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_count_tree_photos = client.get_all_submissions(form_id, process_page_callback = process_page)


table_name = "Submissions.group_existing_site.group_tree_survival.group_own_method.own_method_survived_trees_repeat"


def process_page(json_own_method):
    count = 0  # You can make this global or return it if you want to track total count outside
...
# call the submissions
print('processing the own method data...')
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_own_method = client.get_all_submissions(form_id, process_page_callback = process_page)
