...
def process_page(json_additional_photos):
    ...
    for json_in_photos in json_additional_photos:
        ...
        try:
            photo_1 = json_extract(json_in_photos, 'additional_photo_1')[0]
        except:
            photo_1 = ''

        photo_2 = json_extract(json_in_photos, 'additional_photo_2')[0]
        photo_3 = json_extract(json_in_photos, 'additional_photo_3')[0]
        photo_4 = json_extract(json_in_photos, 'additional_photo_4')[0]
