...
reporting_type TEXT, country TEXT, organisation TEXT, contract_number NUMERIC(20,2), id_planting_site TEXT, land_title TEXT, name_owner TEXT,
...
for json_in in json_registration:
    ...
    if json_extract(json_in, 'reporting_type')[0] == 'new_site':
        ...
        cur.execute('''INSERT INTO ODK_Tree_registration_main (submissionid_odk, ecosia_site_id, device_id, submission_date, field_date, submitter, odk_form_version, test, reporting_type, country, organisation, contract_number, id_planting_site, land_title, name_owner, photo_owner, gender_owner, planting_technique, remark, nr_trees_option, planting_date, tree_number, tree_species, calc_area, lat_y, lon_x, centroid_coord, polygon, line)
        VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)''', (submissionid_odk, ecosia_site_id, device_id, submission_date, today, submitter, odk_form_version, test, reporting_type, country, organisation, contract_number, id_planting_site, land_title, name_owner_individual, photo_owner, gender_owner, planting_technique, remark, nr_trees_option, planting_date, tree_number, tree_species, area_calculation_round_decimal, lat_y, lon_x, geometry_planting_point, geometry_planting_polygon, geometry_planting_line))
