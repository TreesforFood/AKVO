...
rows = cur.fetchall() # output is list of tuples named rows

# Convert to DataFrame
df = pd.DataFrame(rows, columns=['identifier_akvo', 'planting_date', 'polygon'])

# Convert WKT polygon strings to shapely geometries
