...
cur.execute('''
DROP TABLE IF EXISTS Tree_registration_species;
DROP TABLE IF EXISTS Tree_registration_photos;
DROP TABLE IF EXISTS Tree_registration_areas;

CREATE TABLE Tree_registration_areas (identifier_akvo TEXT PRIMARY KEY, display_name TEXT, device_id TEXT, instance INTEGER, submission TEXT, submission_year SMALLINT, submissiontime TEXT, submitter TEXT, modifiedAt TEXT, AKVO_form_version TEXT, country TEXT, test TEXT, organisation TEXT, contract_number NUMERIC(20,2), id_planting_site TEXT, land_title TEXT, name_village TEXT, name_region TEXT, name_owner TEXT, gender_owner TEXT, objective_site TEXT, site_preparation TEXT, planting_technique TEXT, planting_system TEXT, remark TEXT, nr_trees_option TEXT, planting_date TEXT, tree_number INTEGER, estimated_area NUMERIC(20,3), calc_area NUMERIC(20,3), lat_y REAL, lon_x REAL, number_coord_polygon INTEGER, centroid_coord geography(POINT, 4326), polygon geography(POLYGON, 4326), multipoint geography(MULTIPOINT, 4326));

CREATE TABLE Tree_registration_photos (identifier_akvo TEXT, instance INTEGER, photo_url TEXT, photo_location geography(POINT, 4326), FOREIGN KEY (identifier_akvo) REFERENCES Tree_registration_areas (identifier_akvo) ON DELETE CASCADE);

CREATE TABLE Tree_registration_species (identifier_akvo TEXT, instance INTEGER, lat_name_species TEXT, local_name_species TEXT, number_species INTEGER, FOREIGN KEY (identifier_akvo) REFERENCES Tree_registration_areas (identifier_akvo) ON DELETE CASCADE);
...
for all_data in url_list:
    ...
    for level1 in json_dict['formInstances']:
        ...
        cur.execute('''INSERT INTO Tree_registration_areas (identifier_akvo, display_name, device_id, instance, submission, submission_year, submissiontime, submitter, modifiedAt, AKVO_form_version, country, test, organisation, contract_number, id_planting_site, land_title, name_village, name_region, name_owner, gender_owner, objective_site, site_preparation, planting_technique, planting_system, remark, nr_trees_option, planting_date, tree_number, estimated_area, calc_area, lat_y, lon_x, number_coord_polygon, centroid_coord, polygon, multipoint)
        ...
        try:
            ...
            for photo in level1['responses']['1960007']: # Get first 4 photos from registration. This loop was tested in file: AKVO_database_download_v7_test_first_4_reg_photos.py
                ...
                for url4 in photo_items4:
                    ...
                    cur.execute('''INSERT INTO Tree_registration_photos (identifier_akvo, instance, photo_url, photo_location)
        ...
        try:
            ...
            for x in level1['responses']['50330190']:
                ...
                cur.execute('''INSERT INTO Tree_registration_species (identifier_akvo, instance, lat_name_species, local_name_species, number_species)
