...
data = {"client_id": os.getenv["CLIENT_ID"], "username" : os.getenv["USERNAME"], "password": os.getenv["PASSWORD"], "grant_type": os.getenv["GRANT_TYPE"], "scope": os.getenv["SCOPE"]}
...
conn = psycopg2.connect(host= os.getenv["DATABASE_URL"],database= os.getenv["DATABASE_PSTGRS"],user= os.getenv["USER_PSTGRS"],password= os.getenv["PASSWORD_PSTGRS"])
