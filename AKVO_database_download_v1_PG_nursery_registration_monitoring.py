...
data = {"client_id": os.environ.get["CLIENT_ID"], "username" : os.environ.get["USERNAME"], "password": os.environ.get["PASSWORD"], "grant_type": os.environ.get["GRANT_TYPE"], "scope": os.environ.get["SCOPE"]}
...
conn = psycopg2.connect(host= os.environ.get["DATABASE_URL"],database= os.environ.get["DATABASE_PSTGRS"],user= os.environ.get["USER_PSTGRS"],password= os.environ.get["PASSWORD_PSTGRS"])
