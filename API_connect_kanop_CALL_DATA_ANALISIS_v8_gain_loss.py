...
for project_list in project_list_overview: # harvest all project_ids on the KANOP server
    ...
    #print("These project ID's are not yet in the database: ", project_ids_not_in_db)
    ...
    for polygon_id in polygon_id_list:
        ...
        for k,v in variation_metrics_over_time.items():
            ...
            if k == 'results':
                ...
                print("processed polygon Nr:", counter, "project ID: ", kanop_project_id, "identifier_akvo", identifier_akvo)
