...
drop_a16 = '''DROP TABLE IF EXISTS CALC_TAB_Check_on_nurseries;'''
...
ROUND(((AVG(Q1_hgt) + AVG(Q2_hgt) + AVG(Q3_hgt) + AVG(Q4_hgt))/4),2) AS "Average tree height (m)",
...
create_a16 = '''CREATE TABLE CALC_TAB_Check_on_nurseries AS select
