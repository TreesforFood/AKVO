...
json_monitoring_main = client.get_all_submissions(form_id)
...
# call the submissions
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_pcq_method = client.get_all_submissions(form_id)
...
# call the submissions
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_count_trees = client.get_all_submissions(form_id)
...
# call the submissions
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_count_tree_photos = client.get_all_submissions(form_id)
...
# call the submissions
client = ODKCentralClient(base_url, default_project_id, table_name, username, password, page_size)
json_own_method = client.get_all_submissions(form_id)
