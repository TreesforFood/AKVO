...
if len(list_identifiers_30m) > 0:
    ...
    for number_sites_30m in list_reportingunitid_30m:
        count_sites_30m += 1

print('number of sites uploaded: ', count_sites_30m)
...
if len(list_identifiers_10m) > 0:
    ...
    for number_sites_10m in list_reportingunitid_10m:
        count_sites_10m += 1

print('number of sites uploaded: ', count_sites_10m)
