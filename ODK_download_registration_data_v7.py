...
for json_in in json_registration:
    ...
    if data['reporting_type'] == 'new_site':
        ...
        odk_form_version = data['formVersion']
        country = data['country_registration_save']
        test_data_yes_no = data['test_data_yes_no']
        land_title = data['landuse_title']
        name_owner_individual = data['name_owner_individual']
        gender_owner = data['gender_owner']
        name_owner_communal = data['name_owner_communal']
        planting_technique = data['planting_technique']
        test = data['test_data_yes_no']
        reporting_type = data['reporting_type']
        reporting_activity_new_site = data['reporting_activity_new_site']
        area_calculation_round_decimal = data['area_calculation_round_decimal']
        baseline_mature_trees = data['baseline_mature_trees']
        id_planting_site = data['id_planting_site']
        ...
        audit = data['audit']
        meta_instanceID = data['instanceID'] # be carefull: the variable in this json is instanceID NOT instanceId!
