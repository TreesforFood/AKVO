...
DROP TABLE IF EXISTS CALC_TAB_linear_regression_results_satellite_validation;
...
d.estimated_tree_number_planted,
d.estimated_area,
d.area_ha,
NULL AS lat_y,
NULL AS lon_x,
...
ADD contract_number_filter_superset NUMERIC(20,0);

UPDATE superset_ecosia_tree_registration
SET contract_number_filter_superset = CAST(contract_number AS INTEGER);
