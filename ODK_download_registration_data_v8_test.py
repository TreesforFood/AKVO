...
class ODKCentralClient:
    def __init__(self, base_url, default_project_id, username, password, page_size):
        """
    ...
    def _build_endpoint(self, form_id):
        ...
        return (f"{self.base_url}/v1/projects/{self.default_project_id}/forms/"
                f"{form_id}.svc/Submissions?$top={self.page_size}")
...
client = ODKCentralClient(base_url, default_project_id, username, password, page_size)
json_registration = client.get_all_submissions(form_id)
