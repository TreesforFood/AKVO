...
if fetch_download_url[0][0] != True: # Output from this is Boolean! If the result is 'True' then the table is empty (no rows). In that case it will be populated with the initial URL download request
    ...
    CREATE TABLE AKVO_Tree_registration_photos (identifier_akvo TEXT, instance TEXT, photo_url TEXT, photo_geotag_location geography(POINT, 4326), photo_gps_location geography(POINT, 4326));

    CREATE TABLE AKVO_Tree_registration_species (identifier_akvo TEXT, instance TEXT, lat_name_species TEXT, local_name_species TEXT, number_species INTEGER);

    CREATE TABLE AKVO_Tree_registration_areas_baseline_counts (identifier_akvo TEXT, instance TEXT, number_mature_trees INTEGER, avg_diameter_dbh NUMERIC(20,3), avg_height NUMERIC(20,3), example_photo TEXT);

    CREATE TABLE AKVO_Tree_registration_areas_baseline_pcq (identifier_akvo TEXT, instance TEXT, lat_pcq_sample REAL, lon_pcq_sample REAL, height_pcq_sample NUMERIC(20,2), units_circom TEXT, Q1_dist NUMERIC(20,2), Q1_hgt NUMERIC(20,2), Q1_circom NUMERIC(20,2), Q1_spec TEXT, Q2_dist NUMERIC(20,2), Q2_hgt NUMERIC(20,2), Q2_circom NUMERIC(20,2), Q2_spec TEXT, Q3_dist NUMERIC(20,2), Q3_hgt NUMERIC(20,2), Q3_circom NUMERIC(20,2), Q3_spec TEXT, Q4_dist NUMERIC(20,2), Q4_hgt NUMERIC(20,2), Q4_circom NUMERIC(20,2), Q4_spec TEXT, pcq_location geography(POINT, 4326));
