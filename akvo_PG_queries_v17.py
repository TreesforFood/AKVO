...
drop_a19 = '''DROP TABLE IF EXISTS akvo_nursery_monitoring_geom;'''
...
create_a19 = '''CREATE TABLE akvo_nursery_monitoring_geom AS
SELECT
...
GRANT SELECT ON TABLE public.akvo_nursery_monitoring_geom TO kenya_mkec;
...
CREATE POLICY mkec_policy ON akvo_nursery_monitoring_geom TO kenya_mkec USING (EXISTS (SELECT * FROM akvo_nursery_registration
